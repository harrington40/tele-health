...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    location: 'Online',
    isOnline: true,
    bio: 'Dr. Michael Chen is a board-certified internal medicine physician specializing in adult healthcare, preventive medicine, and chronic disease management.',
    education: [
      'MD - Stanford University School of Medicine (2010)',
      'Residency - UCSF Medical Center (2013)',
      'Fellowship - Endocrinology, Mayo Clinic (2014)',
    ],
    experience: 14,
